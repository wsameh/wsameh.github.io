...
const RefProjects: IRefProject[] = [
    {
        ...
        title: 'Makkah Haram Expansion Project',
        // content: [
        //     {
        //         type: 'paragraph',
        //         text: 
        ...
        content: [
            {
                ...
                `I\'m honored to be the BMS and Controls design and supervision Group Leader for the prominent project of Makkah Haram 
                and Mataf Expansion. With a cost of 22 billion dollars the project aims to increase the capacity of the mosque to more 
                than 2 million people. It\s truly a one of kind project. The project comprises of Northern Expansion building with a 
                74 prayer halls spreading over 300,000 square meters, a Central Utility Complex (CUC) that includes a 145,000 TR Chillers 
                Plant, and an Automatic Solid Waste Collection Plant.`
            },
            {
                type: 'paragraph',
                text: 
                `At the heart of the project is IBMS Control Room, that allow remote monitoring and control of all MEP equipment and system
                serving the project, while the Chillers Plant is monitored and controlled by dedicated SCADA system.`
            }
        ],
    },
    {
        ...
        content: [
            {
                ...
                project aims to become the commercial artery the Egypt\'s new Capital, and symbolizes the cutting edge sustainability 
                and Smart Cities design. The project comprises of the following main elements:`
            },
            // {
            //     type: 'list',
        ...
        content: [
            {
                ...
                with the MEP engineers to ensure consistency between the actual MEP equipment selections and the BMS control diagrams.`
            },
            // {
            //     type: 'paragraph',
            //     text: 
            ...
            // { type: 'list', text: `Establish and maintain a link between the Revit elements and the control diagrams.` },
        ...
        content: [
            {
                type: 'paragraph',
                text: 
                `Designers are always faced with the hideous task of delivering an accurate Bill of Quantity (BOQ) 
                that reflect the quantities, meters, and weights of all the elements that constitute the entire BIM. 
                This process is not 100% accurate and consumed significant man-power to produce, even by using the Revit Schedules.`
            },
            {
                type: 'paragraph',
                text: 
                `In an attempt to reduce the man-power to produce a BOQ for the mechanical design. 
                an addin tool is developed, that can accurately quantify all the mechanical elements, 
                in terms of item quantities, meters, and weights, with minimal user intervention.`
            },
            // {
            //     type: 'listHeading',
            //     text: 
